...
<head>
    ...
    <meta name="description"
          content="{{ config.path('app.descriptionLong') }}.">
    ...
    <link rel="stylesheet" type="text/css"
          href="/js/highlight/styles/darcula.css">
    <link rel="stylesheet" href="/css/docs.min.{{ config.path('app.assetTag') }}.css">
    ...
    <title>Zephir Language — Zephir {{ config.path('app.version') }}
        documentation</title>
